...
class _SavedAddressesState extends State<SavedAddresses> {
  ...
  Widget build(BuildContext context) {
    final List<Address> listOfAddressTypes = [
      Address('images/address/ic_homeadd.png',
          AppLocalizations.of(context).homeText, 'Flat Num 114, First Floor, Central Residency\n1024, Central Residency, Hemilton Park,\nNew York, USA'),
      Address('images/address/ic_office.png',
          AppLocalizations.of(context).office, 'Flat Num 114, First Floor, Central Residency\n1024, Central Residency, Hemilton Park,\nNew York, USA'),
      Address('images/address/ic_other.png',
          AppLocalizations.of(context).other, 'Flat Num 114, First Floor, Central Residency\n1024, Central Residency, Hemilton Park,\nNew York, USA'),
    ];
    return Column(
                      ...
                      Container(
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            ...
                            backgroundColor: Theme.of(context).cardColor,
                            child:
                              Image.asset(listOfAddressTypes[index].icon,scale: 3,),
                          ),
                          title: Padding(
